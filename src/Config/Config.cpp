...
const unsigned long FLIP_SERVO_MOVE_DELAY = 2500;      // 1500ms wait for servo to reach position
...
const int FLIP_SERVO_FLIP_POSITION = 180;             // 180 degrees servo position for flipping 