...
const float SERVO_MOVE_DELAY      = 50.0f;     // Time allotted for the servo to complete its movement.
const float SERVO_START_WAIT      = 100.0f;     // Time to wait at start angle before returning home.
...
const float SERVO_START_ANGLE      = 90.0f;   // The angle the servo moves to at start of each cycle.
const float FLIP_ANGLE             = 10.0f;   // The target angle to flip the material.
