...
const float SERVO_START_WAIT      = 500.0f;     // Time to wait at start angle before returning home.
...
const float SERVO_START_ANGLE      = 120.0f;   // The angle the servo moves to at start of each cycle.
