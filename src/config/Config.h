...
// ------------------------------------------------------------------------
const float FEEDING_START_DELAY = 300.0f;     // Delay after start signal before feeding begins.
const float FEED_TIME             = 24300.0f;    // Duration the feed cylinder is active.
...
// ------------------------------------------------------------------------
const float SERVO_HOME_ANGLE       = 20.0f;   // The safe/home position for the servo.
const float FLIP_ANGLE             = 160.0f;   // The target angle to flip the material.
